        ...
        <div class="container">
            ...
            <div class="maincontent">
                <form action="addstudent">
                    <h1>Add a new student for <input type="text" name = "facultyID" readonly value="${param.id}"></h1>
                    ...
                    <table>
                        ...
                        <tr>
                            <td>Enter birth:</td>
                            <td><input type="date"  name="birthday" placeholder="enter birthday" required/></td>
                        </tr>
                        <tr>
                            <td>Enter email:</td>
